...
include($_SERVER['DOCUMENT_ROOT']."/admin/public/uploadifive/function.php");
	...
	$fileParts = pathinfo($_FILES['Filedata']['name']);
		 ResizeFileW(1500,$imgFile,$_SERVER['DOCUMENT_ROOT']."/charlyAngle/public/img/uploadfile/".$imgName,95);
		 cropImage($imgFile,$_SERVER['DOCUMENT_ROOT']."/charlyAngle/public/img/uploadfile/crop/".$imgName,500,375);
