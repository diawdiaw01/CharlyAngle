	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="header-title text-center">
                            <h1 class="text-accent"> <?=$title?> - <?=$knowledgetitle?></h1>
...
<div class="panel panel-filled panel-c-success">
	...
	<script>
        ...
        var knowledge_category_id = <?=$this->uri->segment(4)?>;
	</script>
</section>
...
<!--
                        ...
                        <input type="hidden" id="knowledge_category_id" name="knowledge_category_id" value="<?=$this->uri->segment(4)?>">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                      <select name="Editnews_category_id" id="Editnews_category_id" class="form-control">
                                        ...
                                        ?>
                                        <option value="<?=$value->knowledge_category_id?>" <? if($this->uri->segment(4) == $value->knowledge_category_id){echo "selected";}?>><?=$value->title?></option>
                                        <? }?>
                                        </select>
                                    </div>
                                </div>
