	...
	<div class="modal-body">
                        ...
                        <select name="knowledge_category_id" id="knowledge_category_id" class="form-control" required>
                            <option value="" >กรุณาเลือกหมวดหมู่</option>
                                        <?
                                        foreach(loadKnowledgeCategoryList() as $key => $value){
                                        ?>
                                        <option value="<?=$value->knowledge_category_id?>" ><?=$value->title?></option>
                                        <? }?>
                                        </select>
                        <? }else{?>
                        <input type="hidden" name="knowledge_category_id" id="knowledge_category_id" class="form-control" value="0">
                        <? }?>
                           </div>
                                </div>
                            </div>
						...
						<div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" name="youtube" id="youtube" class="form-control" placeholder="วางลิงค์ Yotube ที่นี่">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" name="finish_adate" id="finish_adate" class="form-control" placeholder="เลือกวันที่ ">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<form action="" id="formGuideEdit" name="formGuideEdit" method="post" enctype="multipart/form-data">
	...
	<div class="modal-body">
	    <!--
						<div class="row clearfix">
                            <div class="col-sm-12">
								<label class="card-inside-title text-danger"><i class="fas fa-th-large"></i> ย้ายหมวดหมู่ข่าว !! </label> <span class="text-warning">(ระบบจะบันทึกอัตโนมัติทันทีที่เลือก ไม่ต้องกดปุ่ม Submit)</span> <i id="editNewsCatID" class="fas text-danger fa-sync-alt fa-spin none"></i>
                                <div class="form-group">
                                    <div class="form-line">
                                      <select name="Editnews_category_id" id="Editnews_category_id" class="form-control">
                                        <?
                                        foreach(loadNewsCategoryList() as $key => $value){
                                        ?>
                                        <option value="<?=$value->news_category_id?>" <? if($this->uri->segment(3) == $value->news_category_id){echo "selected";}?>><?=$value->title?></option>
                                        <? }?>
                                        </select>
                                    </div>
                                </div>
