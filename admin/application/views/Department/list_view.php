                        ...
                        <div class="panel-body">
                            <table class="table table-vertical-align-middle table-bordered" id="tableExample2">
                                ...
                                <tr>
									...
									<th class="text-center" style=" width: 15%;">แก้ไขโดย</th>
	...
	<div class="modal-body">
						...
						<div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <? if($this->uri->segment(3) == '24' || $this->uri->segment(3) == '27'){?>
                                <label class="card-inside-title"> เลขที่คำสั่ง</label>
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" name="departfile_code" id="departfile_code" class="form-control" placeholder="พิมพ์เลขที่คำสั่ง" required>
                                    </div>
                                </div>
                                <label class="card-inside-title"> ปีที่ออกคำสั่ง</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="departfile_year" id="departfile_year" class="form-control" placeholder="พิมพ์ปีที่ออกคำสั่ง" required>
                                    </div>
                                </div>
                                <? }else if($this->uri->segment(3) == '25'){?>
                                <label class="card-inside-title"> วันที่ประกาศ</label>
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" name="departfile_start_date" id="departfile_start_date" class="form-control" placeholder="วันที่ประกาศ" required>
                                    </div>
                                </div>
                                <? }?>
                            </div>
	...
	<div class="modal-body">
						...
						<div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" name="departfile_codeEdit" id="departfile_codeEdit" class="form-control" placeholder="พิมพ์เลขที่คำสั่ง" required>
                                    </div>
                                </div>
                                <label class="card-inside-title"> ปีที่ออกคำสั่ง</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="departfile_yearEdit" id="departfile_yearEdit" class="form-control" placeholder="พิมพ์ปีที่ออกคำสั่ง" required>
                                    </div>
                                </div>
                                <? }else if($this->uri->segment(3) == '25'){?>
                                <label class="card-inside-title"> วันที่ประกาศ</label>
                                <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" name="departfile_start_dateEdit" id="departfile_start_dateEdit" class="form-control" placeholder="วันที่ประกาศ" required>
                                    </div>
                                </div>
                                <? }?>
                            </div>
